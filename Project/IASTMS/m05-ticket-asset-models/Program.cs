...
while (keepRunning)
{
    ...
    if(option == 1)
    {
        ...
        while (true)
        {
            ...
            technician.Role = Console.ReadLine();
            if(technician.Role == "Admin" || technician.Role == "Technician" || technician.Role == "Viewer")
            {
                break;
            }
            else
        ...
        while (true)
        {
            ...
            if (asset.Brand == "Lenovo" || asset.Brand == "MacBook" || asset.Brand == "HP")
            {
               break;
            }  
            else
        ...
        asset.Age = Convert.ToInt32(Console.ReadLine());
        ...
        while (true)
        {
            ...
            {
                asset.isDamaged = GetDeviceDamageStatus(input);
                break;
            }
            else
            {
        ...
        while (true)
        {
            ...
            ticket.Severity = Convert.ToInt32(Console.ReadLine());
        ...
        while (true)
        {
            ...
            if (ticket.Status == "Open" || ticket.Status == "In Progress" || ticket.Status == "Closed" )
            {
                break;
            }
            else
