...
TicketStorageService ticketStorageService = new TicketStorageService();
...
while (keepRunning)
{
    ...
    switch (option)
    {
        ...
        case 7:
            ...
            ticketStorageService.SaveTicketsToTextFile(tickets);
            break;
        case 8:
            //Save tickets into text file
            ticketStorageService.LoadTicketsFromTextFile(tickets);
            break;
        case 9:
            //Save tickets into text file
            ticketStorageService.SaveTicketToJson(tickets);
            break;
        case 10:
            //Save tickets into text file
            ticketStorageService.LoadTicketsFromJsonFile(tickets);
            break;
        case 11:
            //Close program
